 ...
 */
class m160511_023718_create_articles_table extends Migration
{
    /**
     * @inheritdoc
     */
    public function up()
    {
        ...
        $this->addForeignKey(
            'usercreatearticle', 'articles', 'created_by', 'user', 'id', 'no action', 'no action'
        );
        
        $this->addForeignKey(
            'userupdatearticle', 'articles', 'updated_by', 'user', 'id', 'no action', 'no action'
        );
    }

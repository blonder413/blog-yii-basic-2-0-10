...
<head>
    ...
    <?php $this->head() ?>
    <link href="<?= Yii::$app->homeUrl ?>web/css/halloween/style.css" rel="stylesheet" type="text/css">
...
$(document).ready(function() {
    ...
    var aleatorio = getRandomArbitrary(0,1000000);
    ...
    <header>
        <?php
            ...
            echo Nav::widget([
                ...
                'items' => [
                    Html::img('@web/web/img/logoHalloween2016.png', ['class'=>'img-responsive', 'width'=>'30px'])
                ],
            ]);
            echo Nav::widget([
...
<!--
    <section class="jumbotron">
        <div class="container">
            <h1 class="title-blog">
              <?= Html::img('@web/web/img/logoHalloween2016.png', ['width'=>'70']) ?>
              Blonder413
            </h1>
    ...
    <section class="main container">
      <div class="row">
            ...
            <div class="col-sm-12 col-md-12">
                ...
                switch ($numDia) {
                    case 1: // lunes
                        $img = '@web/web/img/banner/lunes.png';
                        $alt = 'PHP';
                        break;
                    case 2: // martes
                        $img = '@web/web/img/banner/martes.png';
                        $alt = 'PHP';
                        break;
                    case 3: // miércoles
                        $img = '@web/web/img/banner/miercoles.png';
                        $alt = 'YiiFramework 2';
                        break;
                    case 4: // jueves
                        $img = '@web/web/img/banner/jueves.png';
                        $alt = 'Java';
                        break;
                    case 5: // viernes
                        $img = '@web/web/img/banner/viernes.png';
                        $alt = 'PHP';
                        break;
                    default:
                        $img = '@web/web/img/banner/viernes.png';
            ...
            <?= Html::a(
                ...
                'http://www.manosenelcodigo.com/en-vivo',
        ...
        <aside class="hidden-xs hidden-sm col-md-3">
            ...
            <div class="panel panel-primary">
                ...
                <div class="list-group">
                    <div class="list-group">
                        <div class="fb-page" data-href="https://www.facebook.com/Blonder413-1108716669224105/" data-tabs="timeline" data-width="340" data-height="700" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Blonder413-1108716669224105/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Blonder413-1108716669224105/">Blonder413</a></blockquote></div>
                    </div>
                </div>
            </div>
            <!-------------------------------------------------------------------------------------------------------->

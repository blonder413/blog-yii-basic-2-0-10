...
class AuthItemController extends Controller
{
    ...
    {
        if (!Yii::$app->user->can('list-auth-items')) {
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->save()) {
                Yii::$app->session->setFlash('success', 'Authentication Item created successfully');
            } else {
                Yii::$app->session->setFlash('error', "Authentication Item can't be created");
            }
